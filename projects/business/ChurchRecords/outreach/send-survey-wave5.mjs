...
const contacts = [
  { name: 'Community Baptist Church Tulsa',     email: 'amburn.steve@gmail.com' },
  { name: 'First Baptist Church Memphis',       email: 'jsalemi@fbcmemphis.org' },
  { name: 'St. Paul Baptist Church Memphis',    email: 'info@spbcmemphis.org' },
  { name: 'Second Baptist Church Memphis',      email: 'info@2ndmemphis.org' },
  { name: 'Kingdom Church Memphis',             email: 'info@kingdomchurchmemphis.org' },
  { name: 'Greater New Kingdom Church Memphis', email: 'info@mygnkc.org' },
  { name: 'The Remnant Church OKC',             email: 'contact@theremnantchurch.tv' },
];
...
async function main() {
  console.log(`Sending wave 5 — ${contacts.length} churches...\n`);
