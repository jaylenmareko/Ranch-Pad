---
name: blast-master
description: Use this skill when building deterministic automations, Python-based workflows, API integrations, or multi-phase projects. Applies the B.L.A.S.T. protocol (Blueprint, Link, Architect, Stylize, Trigger) and A.N.T. 3-layer architecture to ensure reliability and self-healing automation.
---
...
- **Local (`.tmp/`):** All scraped data, logs, and temporary files. Ephemeral and can be deleted.
