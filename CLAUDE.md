...
- At the start of every session read the relevant file in `sessions/` — mirrors `projects/` structure (e.g. `sessions/business/ranchpad.md`, `sessions/school/sophia.md`)
